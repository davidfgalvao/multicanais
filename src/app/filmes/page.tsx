export const metadata = {
  title: "Filmes | StreamFutebol",
  description: "Aba de filmes com frame interno para testes.",
};
  ...
  return (
    <div className="w-full px-0 py-4 pb-10 md:py-6">
      ...
      <div className="mx-auto w-full max-w-[95vw] px-1">
        <a
          href="https://www14.redecanais.in/"
          target="_blank"
